...
<section id="desaingrafis" class="w-full">
    ...
    <div id="header" class="container mt-20 flex w-full flex-col items-center justify-center py-32">
        ...
        <div class="flex flex-row gap-2">
            <img src="{{ asset('storage/img/Illustrator.png') }}" class="h-8 w-auto object-contain opacity-75">
            <img src="{{ asset('storage/img/Photoshop.png') }}" class="h-8 w-auto object-contain opacity-75">
        </div>
    </div>
