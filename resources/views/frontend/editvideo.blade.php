...
<section id="edit-video" class="w-full">
    <div id="header" class="container mt-20 flex w-full flex-col items-center justify-center py-32">
        <h1>EDIT VIDEO</h1>
        <p class="text-black-60 mb-4 max-w-[60%] text-center text-lg italic">Kami bisa bantu kamu untuk membuat video
            Company Profile, After Movie, Reveal Logo, Bumper Video, Video Kenang-kenangan dll.</p>
...
@include('frontend.component.modal-video')
