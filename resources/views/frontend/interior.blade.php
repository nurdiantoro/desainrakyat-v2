...
<section id="desain-interior" class="w-full">
    <div id="header" class="container mt-20 flex w-full flex-col items-center justify-center py-32">
        ...
        <p class="text-black-60 mb-4 max-w-[60%] text-center text-lg italic">Kami bisa bantu kamu untuk membuat Desain Interior ruangan yang nyaman dan argonomis, mewujudkan rumah impian kamu menjadi kenyataan dengan visual seperti asli.</p>
